...
from deepface1.deepface.basemodels import (
    VGGFace,
    OpenFace,
    Facenet,
    Facenet512,
...
from deepface1.deepface.extendedmodels import Age, Gender, Race, Emotion
from deepface1.deepface.commons import functions, realtime, distance as dst
...
def find(
    ...
    if path.exists(db_path + "/" + file_name):
        ...
        for index in pbar:
            ...
            img_objs,face_detected = functions.extract_faces(
                img=employee,
                target_size=target_size,
                detector_backend=detector_backend,
                grayscale=False,
    ...
    target_objs,face_detected = functions.extract_faces(
        img=img_path,
        target_size=target_size,
        detector_backend=detector_backend,
        grayscale=False,
...
#funzione modificata da me ->>>>>>>>> ho aggiunto model e ho tolto il build model
def represent(
    img_path,
    #model,
    model_name="VGG-Face",
