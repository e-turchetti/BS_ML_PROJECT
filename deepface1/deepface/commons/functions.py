...
from deepface1.deepface.detectors import FaceDetector
...
#MODIFICATA DA ME->>>>>>>>>>>>>>>>>>>>> messo face_Detector negli args e tolto il build_model
def extract_faces(
    img,
    #face_detector,
    target_size=(224, 224),
    ...
    return extracted_faces,face_detected  
